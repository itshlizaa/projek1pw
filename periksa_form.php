<?php 
  ...
  $result_pasien = $dbh->query($sql_pasien);
  $sql_dokter = "SELECT id FROM paramedik";
  $result_dokter = $dbh->query($sql_dokter);
?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #FFA5A5;">
    ...
    <div class="sidebar" style="background-color: #FFCBCC;">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="periksa_index.php" class="nav-link" style="color: #FF7272; text-decoration: none; background-color: #FFFFFF;" id="link1" onclick="changeBackground('link1', '#F5E6EB')">
        ...
        <div class="container-fluid card-body">
            <form class="form" method="post" action="periksa_proses.php">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input style="border-color: #FFA5A5;" type="date" id="tanggal" name="tanggal" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input style="border-color: #FFA5A5;" type="number" id="berat" name="berat" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input style="border-color: #FFA5A5;" type="number" id="tinggi" name="tinggi" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input style="border-color: #FFA5A5;" type="text" id="tensi" name="tensi" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <textarea style="border-color: #FFA5A5;" type="text" id="keterangan" name="keterangan" class="form-control"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select id="pasien_id" name="pasien_id" required="required" class="form-control" style="border-color: #FFA5A5;">
                            ...
                            <?php
                            // Loop through hasil query untuk ID pasien
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select id="dokter_id" name="dokter_id" required="required" class="form-control" style="border-color: #FFA5A5;">
                            ...
                            <?php
                            // Loop through hasil query untuk ID dokter
                            while ($row = $result_dokter->fetch(PDO::FETCH_ASSOC)) {
                                echo "<option value='" . $row['id'] . "'>" . $row['id'] . "</option>";
                            }
                            ?>
                        </select>
