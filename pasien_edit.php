...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #Fzzz;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
...
<section class="content">
  <div class="container-fluid card-body">
    <form class="form" method="post" action="pasien_proses.php">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input style="border-color: #FFA5C6;" type="text" id="kode" name="kode" class="form-control" value="<?= $row['kode'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input style="border-color: #FFA5C6;" type="text" id="nama" name="nama" class="form-control" value="<?= $row['nama'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input style="border-color: #FFA5C6;" type="text" id="tmp_lahir" name="tmp_lahir" class="form-control" value="<?= $row['tmp_lahir'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input style="border-color: #FFA5C6;" type="text" id="tgl_lahir" name="tgl_lahir" class="form-control" value="<?= $row['tgl_lahir'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="form-check form-check-inline">
                <input style="border-color: #FFA5C6;" type="radio" id="genderL" name="gender" value="L" class="form-check-input">
                <label for="genderL" class="form-check-label">Laki-laki</label>
            </div>
            <div class="form-check form-check-inline">
                <input style="border-color: #FFA5C6;" type="radio" id="genderP" name="gender" value="P" class="form-check-input">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input style="border-color: #FFA5C6;" type="text" id="email" name="email" class="form-control" value="<?= $row['email'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input style="border-color: #FFA5C6;" type="text" id="alamat" name="alamat" class="form-control" value="<?= $row['alamat'] ?>">
            </div>
        </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <select id="kelurahan_id" name="kelurahan_id" required="required" class="form-control" style="border-color: #FFA5C6;">
