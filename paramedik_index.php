  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #FFA5A5;">
    ...
    <div class="sidebar" style="background-color: #FFCBCC;">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="periksa_index.php" class="nav-link" style="color: #000000; text-decoration: none;" onmousedown="this.style.color='#FFA5A5'" onmouseup="this.style.color='#FFA5A5'">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="paramedik_index.php" class="nav-link" style="color: #FF7272; text-decoration: none; background-color: #FFFFFF;" id="link1" onclick="changeBackground('link1', '#FFE5E5')">
      ...
      <table class="table table-bordered" style="border-collapse: collapse; border: 2px solid #FFA5A5;">
        <thead style="background-color: #FFA5A5;">
            <tr>
                ...
                <th style="border: 2px solid #FF7272; padding: 8px; text-align: left;">Nama</th>
                <th style="border: 2px solid #FF7272; padding: 8px; text-align: left;">Tempat Lahir</th>
                <th style="border: 2px solid #FF7272; padding: 8px; text-align: left;">Tanggal Lahir</th>
                <th style="border: 2px solid #FF7272; padding: 8px; text-align: left;">Kategori</th>
                <th style="border: 2px solid #FF7272; padding: 8px; text-align: left;">Telepon</th>
                <th style="border: 2px solid #FF7272; padding: 8px; text-align: left;">Alamat</th>
                <th style="border: 2px solid #FF7272; padding: 8px; text-align: left;">Unit Kerja ID</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td style="border: 2px solid #FFA5A5; padding: 8px; text-align: left;"><?=$row['nama']?></td>
                    <td style="border: 2px solid #FFA5A5; padding: 8px; text-align: left;"><?=$row['tmp_lahir']?></td>
                    <td style="border: 2px solid #FFA5A5; padding: 8px; text-align: left;"><?=$row['tgl_lahir']?></td>
                    <td style="border: 2px solid #FFA5A5; padding: 8px; text-align: left;"><?=$row['kategori']?></td>
                    <td style="border: 2px solid #FFA5A5; padding: 8px; text-align: left;"><?=$row['telepon']?></td>
                    <td style="border: 2px solid #FFA5A5; padding: 8px; text-align: left;"><?=$row['alamat']?></td>
                    <td style="border: 2px solid #FFA5A5; padding: 8px; text-align: left;"><?=$row['unitkerja_id']?></td>
                    <td style="border: 2px solid #FFA5A5; padding: 8px; text-align: left;">
                        <a class="btn" style="background-color: #77DD77; color: #000000; border: none; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; box-shadow: 2px 2px 4px #555555;" onmouseover="this.style.backgroundColor='#3CB371'" onmouseout="this.style.backgroundColor='#77DD77'" href="paramedik_edit.php?idedit=<?=$row['id']?>">Edit</a>
                        <a class="btn" style="background-color: #F08080; color: #000000; border: none; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; box-shadow: 2px 2px 4px #555555;" onmouseover="this.style.backgroundColor='#CD5C5C'" onmouseout="this.style.backgroundColor='#F08080'" href="paramedik_delete.php?iddel=<?=$row['id']?>"
                        onclick="if(!confirm('Anda Yakin Ingin Menghapus Data Paramedik <?=$row['nama']?>?')) {return false}"
                        >Delete</a>
                    </td>
                </tr>
            <?php 
