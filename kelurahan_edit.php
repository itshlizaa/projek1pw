  ...
  <div class="container-fluid card-body">
    <form class="form" method="post" action="kelurahan_proses.php">
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input style="border-color: #A5A5A5;" type="text" id="nama" name="nama" class="form-control" value="<?= $row['nama'] ?>">
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input style="border-color: #A5A5A5;" type="text" id="kec_id" name="kec_id" class="form-control" value="<?= $row['kec_id'] ?>">
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <input style="background-color: #77DD77; color: #000000; border: none; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; box-shadow: 2px 2px 4px #555555;" onmouseover="this.style.backgroundColor='#3CB371'" onmouseout="this.style.backgroundColor='#77DD77'" class="btn btn-success" type="submit" name="proses" type="submit" value="<?= $button ?>" />
