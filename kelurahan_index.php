  ...
  <div class="content-wrapper" style="background-color: #E5E5E5;">
    ...
    <section class="content">
      <div class="container-fluid card-body">
        <table class="table table-bordered" style="border-collapse: collapse; border: 2px solid #A5A5A5;">
          <thead style="background-color: #A5A5A5;">
            <tr>
                ...
                <th style="border: 2px solid #000000; padding: 8px; text-align: left;">Kec. ID</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="border: 2px solid #A5A5A5; padding: 8px; text-align: left;"><?=$row['kec_id']?></td>
              <td style="border: 2px solid #A5A5A5; padding: 8px; text-align: left;">
                  <a class="btn" style="background-color: #77DD77; color: #000000; border: 2px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; box-shadow: 2px 2px 4px #555555;" onmouseover="this.style.backgroundColor='#3CB371'" onmouseout="this.style.backgroundColor='#77DD77'" href="kelurahan_edit.php?idedit=<?=$row['id']?>">Edit</a>
                  <a class="btn" style="background-color: #F08080; color: #000000; border: none; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; box-shadow: 2px 2px 4px #555555;" onmouseover="this.style.backgroundColor='#CD5C5C'" onmouseout="this.style.backgroundColor='#F08080'" href="kelurahan_delete.php?iddel=<?=$row['id']?>"
                  onclick="if(!confirm('Anda Yakin Ingin Menghapus Data Kelurahan <?=$row['nama']?>?')) {return false}"
                  >Delete</a>
              </td>
            </tr>
            <?php 
        ...
        <br>
        <div class="container">
          <a class="btn" style="background-color: #A5A5A5; color: #000000; border: none; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; box-shadow: 2px 2px 4px #555555;" onmouseover="this.style.backgroundColor='#7F7F7F'" onmouseout="this.style.backgroundColor='#A5A5A5'" href="kelurahan_form.php">Create New Data</a>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    <!-- /.content -->
