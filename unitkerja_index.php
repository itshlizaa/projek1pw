    ...
    <div class="sidebar" style="background-color: #CCCCCC;">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="kelurahan_index.php" class="nav-link" style="color: #000000; text-decoration: none;" onmousedown="this.style.color='#A5A5A5'" onmouseup="this.style.color='#A5A5A5'">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="unitkerja_index.php" class="nav-link" style="color: #000000; text-decoration: none; background-color: #FFFFFF;" id="link1" onclick="changeBackground('link1', '#E5E5E5')">
  ...
  <div class="content-wrapper" style="background-color: #E5E5E5;">
    ...
    <section class="content">
      <div class="container-fluid card-body">
        <table class="table table-bordered" style="border-collapse: collapse; border: 2px solid #A5A5A5;">
          <thead style="background-color: #A5A5A5;">
            <tr>
                <th style="border: 2px solid #000000; padding: 8px; text-align: left;">No</th>
                <th style="border: 2px solid #000000; padding: 8px; text-align: left;">Nama</th>
                <th style="border: 2px solid #000000; padding: 8px; text-align: left;">Action</th>
            </tr>
          </thead>
          <tbody>
            <?php 
            ...
            ?>
            <tr>
              <td style="border: 2px solid #A5A5A5; padding: 8px; text-align: left;"><?=$nomor?></td>
              <td style="border: 2px solid #A5A5A5; padding: 8px; text-align: left;"><?=$row['nama']?></td>
              <td style="border: 2px solid #A5A5A5; padding: 8px; text-align: left;">
                  <a class="btn" style="background-color: #77DD77; color: #000000; border: 2px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; box-shadow: 2px 2px 4px #555555;" onmouseover="this.style.backgroundColor='#3CB371'" onmouseout="this.style.backgroundColor='#77DD77'" href="unitkerja_edit.php?idedit=<?=$row['id']?>">Edit</a>
                  <a class="btn" style="background-color: #F08080; color: #000000; border: none; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; box-shadow: 2px 2px 4px #555555;" onmouseover="this.style.backgroundColor='#CD5C5C'" onmouseout="this.style.backgroundColor='#F08080'" ref="unitkerja_delete.php?iddel=<?=$row['id']?>"
                  onclick="if(!confirm('Anda Yakin Ingin Menghapus Data Unit Kerja <?=$row['nama']?>?')) {return false}"
                  >Delete</a>
              </td>
            </tr>
            <?php 
        ...
        <br>
        <div class="container">
          <a class="btn" style="background-color: #A5A5A5; color: #000000; border: none; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; box-shadow: 2px 2px 4px #555555;" onmouseover="this.style.backgroundColor='#7F7F7F'" onmouseout="this.style.backgroundColor='#A5A5A5'" href="unitkerja_form.php">Create New Data</a>
        </div>
      </div><!-- /.container-fluid -->
    </section>
    <!-- /.content -->
